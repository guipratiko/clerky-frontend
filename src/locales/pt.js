...
export const pt = {
  ...
  auth: {
    ...
    accountApproval: 'Sua conta foi criada com sucesso!',
    approvalNotification: 'Para liberar o acesso ao sistema, você precisa aderir a um plano de assinatura.',
    afterApproval: 'Após a confirmação do pagamento, você receberá um link para ativar sua conta e começar a usar o sistema.',
